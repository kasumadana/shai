...
// Interface untuk menampung respons dari API
...
export default function DetectorClient() {
  ...
  // Fungsi handler untuk tombol "Analisis Sekarang"
  const handleAnalyzeSubmit = async () => {
    ...
    try {
      // Melakukan request POST ke endpoint API lokal
      ...
      setResult(data) // Simpan hasil analisis
    } catch (err) {
  ...
  // Helper: Menentukan warna & ikon berdasarkan tingkat bahaya (severity)
  ...
  return (
    <div className="min-h-screen bg-soft-cream">
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 pt-24">
        ...
        {/* Area Hasil Analisis (Conditional Rendering) */}
